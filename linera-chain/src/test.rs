...
pub trait BlockTestExt: Sized {
    ...
    fn into_first_proposal(self, key_pair: &Secp256k1KeyPair) -> BlockProposal {
    ...
    fn into_proposal_with_round(self, key_pair: &Secp256k1KeyPair, round: Round) -> BlockProposal;
}
...
impl BlockTestExt for ProposedBlock {
    ...
    fn into_proposal_with_round(self, key_pair: &Secp256k1KeyPair, round: Round) -> BlockProposal {
        BlockProposal::new_initial(round, self, &key_pair.secret_key)
    }
}

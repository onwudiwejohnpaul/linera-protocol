...
use linera_base::{
    crypto::{secp256k1::Secp256k1PublicKey, CryptoError},
...
pub struct ValidatorName(pub Secp256k1PublicKey);
...
impl<'de> Deserialize<'de> for ValidatorName {
        ...
        D: serde::de::Deserializer<'de>,
    {
        if deserializer.is_human_readable() {
            ...
            struct ValidatorNameDerived(Secp256k1PublicKey);
...
impl std::str::FromStr for ValidatorName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(ValidatorName(Secp256k1PublicKey::from_str(s)?))
    }
}
...
impl From<Secp256k1PublicKey> for ValidatorName {
...
impl Committee {
    ...
    pub fn keys_and_weights(&self) -> impl Iterator<Item = (Secp256k1PublicKey, u64)> + '_ {
        self.validators
            .iter()
